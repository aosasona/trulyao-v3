    ...
    <section className="mt-12" id="skills">
      <div>
        ...
        <p className="text-faded leading-relaxed text-sm">
          ...
          to give you a sense of what anything is like. This list might go since
          I have dabbled into quite a bit of other stuff - including Graphic
          design, so I have only listed the most{" "}
